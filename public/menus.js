  ...
  switch (option) {
    ...
    */
    ...
    case "swapHidden":
      {
        pushSnapshot();
        let currentBack = document.getElementById("cy").style.backgroundColor;
        //console.log(currentBack)
        if (currentBack == "white")
          document.getElementById("cy").style.backgroundColor = "LightYellow";
        else document.getElementById("cy").style.backgroundColor = "white";
    ...
    */
    ...
    case "deleteNodesSelected":
      pushSnapshot();
      cy.nodes(":selected:visible").remove();
      break;
  }
  // refresh status bar
  metrologie();
...
case "edgeIsTriggerGenerated":
   ...
   break;
    ...
    case "deleteEdgesSelected":
      pushSnapshot();
      cy.edges(":selected:visible").remove();
      break;
